for i=1:25
    for j=1:14
    filtspace{i}(:,j)=filter(bp1,space{i}(:,j));
    end
    for j=33:64
...
for i=1:8
    for j=1:25
        modspace{25*(i-1)+j}=spacemod{i,j};
    end
end
filtspace=modspace;
...
for i=1:25
    for j=1:14
    filtback{i}(:,j)=filter(bp1,back{i}(:,j));
    end
    for j=33:64
...
for i=1:25
    for j=1:14
    filtcomma{i}(:,j)=filter(bp1,comma{i}(:,j));
    end
    for j=33:64
...
for i=1:8
    for j=1:25
        modcomma{25*(i-1)+j}=commamod{i,j};
    end
end
filtcomma=modcomma;
...
for i=1:25
    for j=1:14
    filtdot{i}(:,j)=filter(bp1,dot{i}(:,j));
    end
    for j=33:64
